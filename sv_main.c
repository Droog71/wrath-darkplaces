...
// send serverinfo to all connected clients, and set up botclients coming back from a level change
	...
	if(cls.state == ca_dedicated)
		...
		SCR_PushLoadingScreen(true, "Starting", 1);
...
static void SV_VM_Setup(void)
{
	...
	if (prog->progs_crc == PROGHEADER_CRC || prog->progs_crc == PROGHEADER_CRC_TENEBRAE)
	{
		...
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm18);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm19);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm20);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm21);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm22);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm23);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm24);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm25);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm26);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm27);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm28);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm29);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm30);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm31);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm32);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm33);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm34);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm35);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm36);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm37);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm38);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm39);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm40);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm41);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm42);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm43);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm44);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm45);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm46);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm47);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm48);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm49);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm50);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm51);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm52);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm53);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm54);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm55);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm56);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm57);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm58);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm59);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm60);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm61);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm62);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm63);
		PRVM_ED_FindGlobalOffset_FromStruct(globalvars_t, parm64);
